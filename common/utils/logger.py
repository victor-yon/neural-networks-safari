...
class SexyLogger(logging.Logger):
    ...
    def remove_all_handler(self) -> None:
        """
        Remove all handler previously set to this logger.
        """
...
def setup_logger() -> SexyLogger:
    """
    Setup default handler for lightning logger.
    """
    # Remove default lightning console handler and setup mine
    # noinspection PyTypeChecker
    logger_lightning: SexyLogger = logging.getLogger('pytorch_lightning')
    logger_lightning.remove_all_handler()
    logger_lightning.setup(console_log_level='INFO')

    # Creat the logger to use in this app
    # noinspection PyTypeChecker
    current_logger: SexyLogger = logging.getLogger('nn-safari')
    current_logger.setup(console_log_level='INFO')

    return current_logger


# Set sexy logger as default for the logger factory
logging.setLoggerClass(SexyLogger)
logger = logging.getLogger('nn-safari')
